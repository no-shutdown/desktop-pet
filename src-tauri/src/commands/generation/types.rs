...
const STATE_DEFINITIONS: [StateDefinition; 4] = [
    ...
    StateDefinition {
        ...
        label: "走路",
        delay_ms: 100,
        action: "in-place walking cycle facing right, distributed evenly across the 8 frames as a loopable gait; frames 1 and 5 are contact poses with legs at maximum spread and opposite arms swung, frames 2-4 pass through the mid-stride with the back leg lifting forward, frames 6-8 mirror that motion on the other leg; body bobs subtly up and down but the character's absolute horizontal position stays fixed at the frame center; frame 8 flows seamlessly back into frame 1",
